...
foreach ($cookies as $cookie) {
	$ingredients = $database->getCookieIngredients($cookie['cookieName']);
...
$ingredients = $database->getIngredients();
	...
	print '<tr>';
	print '<th>Ingredient</th>';
	print '<th>In Storage</th>';
	print '<th>Date last delivered</th>';
	print '</tr>';
	print '</thead>';
	print '<tbody>';		
...
foreach ($ingredients as $ingredient) {
	...
	print '<tr>';
	print '<td>' . $ingredient['ingredientName'] . '</td>';
	print '<td>' . $ingredient['currentAmount'] . ' ' . $ingredient['unit'] . '</td>';
	print '<td>' . $ingredient['dateLastDelivered'] . '</td>';
	print '</tr>';
}
