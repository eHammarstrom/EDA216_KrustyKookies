        ...
        <div class="container marketing">
            ...
            <div>
                ...
                <div class="row" style="margin-top:3%">
                    <div class="col-md-6">
                        ...
                        <div class="well">
                        <p> All available pallets are listed below. There are search and filter functions which updates dynamically.</p>
                        </div>
                        <div class="row">
                            <div class="col-md-10">
            ...
            <form class="entry form-group" method="post" id="formBlockPallet">
                <div class="form-group">
                    <h1>Block Pallets</h1>
                    <div class="well">
                        <p> If a sample doesn’t meet the quality standards, all pallets containing that product that have been produced during a specific time interval should be blocked. This is done by first spcifying the cookie type, and then the time interval.</p>
                    </div>
                    <label>Cookie</label>
                    <div class="form-group">
